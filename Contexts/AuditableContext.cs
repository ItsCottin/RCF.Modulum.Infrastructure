using modulum.Application.Enums;
using modulum.Infrastructure.Models.Audit;
...
{
    public abstract class AuditableContext : IdentityDbContext<ModulumUser, ModulumRole, int>
    {
