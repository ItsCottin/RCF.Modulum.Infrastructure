    ...
    public class IdentityService : ITokenService
    {
        ...
        private async Task<IEnumerable<Claim>> GetClaimsAsync(ModulumUser user)
        {
            ...
            var claims = new List<Claim>
            {
                ...
                new(ClaimTypes.Email, user?.Email),  // O Comentario abaixo ocasionou em um erro no front
                new(ClaimTypes.Name, user? .UserName) // Ponto onde esta dando erro para usuarios novos pois usuarios novos esta com NomeCompleto null na base
            }
            .Union(userClaims)
            .Union(roleClaims);
